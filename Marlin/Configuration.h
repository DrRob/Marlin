...
#define STRING_CONFIG_H_AUTHOR "(DrRob, Ender-5)" // Who made the changes.
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 40, 80 } // ...or, set your own edit limits
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 200, 150 } // ...or, set your own edit limits
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 10
    ...
    // Enable this option to use a filament motion sensor that outputs a
    // voltage that sweeps across a range and back as the filament tension
    // bearing rotates.
    #define FILAMENT_ANALOG_MOTION_SENSOR
  #endif

  #ifdef FILAMENT_ANALOG_MOTION_SENSOR
    #define FILAMENT_RUNOUT_THRESHOLD 5

    // If using an analog filament motion sensor then detect motion when
    // the value has changed by this threshold amount.
    // (Don't make it too small as there will be some noise in the signal.
    //  Don't make it too large as this affects how quickly a problem will
    //  be detected.)
    #define FILAMENT_ANALOG_MOTION_THRESHOLD 4
  #endif
#endif
